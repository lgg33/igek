		...
		<div class="container"   >
			<nav class="navbar navbar-default navbar-static-top">
  				<div class="container" style="font-size: 25px;background-color:paleturquoise; ">
					...
					<div class="col-md-2 fontcontrol2"><a href="Thenews.jsp">igek资讯</a></div>
					<div class="col-md-2 fontcontrol2"><a href="hotgood">最热商品</a></div>
					<div class="col-md-2 fontcontrol2"><a href="#">关于</a></div>
  				</div>
			</nav>
		</div>