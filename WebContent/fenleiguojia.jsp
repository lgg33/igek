...
<body>
		...
		<div class="container" >
			<div class="row">
			<c:forEach items="${countrygs}" var="good"> 
			...
			<div align="center">
								...
								<nav aria-label="Page navigation">
									<ul class="pagination">
										<li><a
											href="guojia?page=${page.firstPage}&countryid=${country.id}"
											aria-label="Previous"> <span aria-hidden="true">«</span>
										</a></li>
										<c:forEach var="s" begin="1" end="${page.pages}">
											<li><a
												href="guojia?page=${s}&countryid=${country.id}">${s}</a></li>
										</c:forEach>
										<li><a
											href="guojia?page=${page.lastPage}&countryid=${country.id}"
