...
<body>
		...
		<div class="container" >
			<div class="row">
			<c:forEach items="${gslist}" var="good"> 
			...
			<div align="center">
								...
								<nav aria-label="Page navigation">
									<ul class="pagination">
										<li><a
											href="fenlei?page=${page.firstPage}&categoryid=${feilei.cid }"
											aria-label="Previous"> <span aria-hidden="true">«</span>
										</a></li>
										<c:forEach var="s" begin="1" end="${page.pages}">
											<li><a
												href="fenlei?page=${s}categoryid=${feilei.cid }">${s}</a></li>
										</c:forEach>
										<li><a
											href="fenlei?page=${page.lastPage}&categoryid=${feilei.cid }"
