    	...
    	<br>
 		...
 		<div class="container">
 			<table class="table table-condensed">
		 			<tr class="active">
		 				<td><input type="checkbox" name="ch1" id="ch1" value="0" onclick="quan()"/>全选</td>
		 				<td >订单号</td>
		 				<td >地址</td>
						<td >商品名</td>
						<td >商品单价</td>
					...
					<c:forEach  var="order"  items="${orders }">
							<tr class="warning">
								...
								<td><input type="checkbox" name="ch" id="" value="${ order.oid}" />
								...
								<td >   ${ order.otime}</td>
								<td >
									<a href="deleteOrder?uid=${order.uid }&oid=${ order.oid }"><img src="img/schu.png" alt="删除" title="删除"/></a>
								</td>
							</tr>
				</c:forEach>
			...
			<div class="container">
				...
				<button type="button"   style="margin-right: 20px" onclick="queren1()">确认购买</button>
			</div>
		<!-- 底部 -->
		<br><br><br>
		<div class="container">
