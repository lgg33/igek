				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						...
						<div class="caption">
					        ...
					        <p align="center">
					        	<a href="#" class="btn btn-default" role="button" style="width:40%;height:30px;font-size: 13px;background: red;"><span style="color: white">立即购买</span></a> 
					        	<a href="#" class="btn btn-default" role="button" style="width:40%;height:30px;font-size: 13px;border: solid 2px red;background: white">加入购物车</a>
					        </p>
					    </div>
					</div>
				</div>
